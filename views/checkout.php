...
<div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    <div class="px-4 pt-8">
        ...
        <a href="http://localhost:8888/views/menu.php">
            <button type="submit"
        ...
        <form class="mt-5 grid gap-6" action="https://www.youtube.com/watch?v=dQw4w9WgXcQ&pp=ygUJcmljayByb2xs">
            <div class="relative">
                <input class="peer hidden" id="radio_1" type="radio" name="radio" checked/>
                <span class="peer-checked:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
                <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
                       for="radio_1">
                    <img class="w-14 object-contain" src="../resources/images/tng-logo-ewallet.png" alt="TNG payment"/>
                    <div class="ml-5">
                        <span class="mt-2 font-semibold">Touch 'n Go eWallet</span>
            ...
            <div class="relative">
                ...
                <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
                    ...
                    <div class="ml-5">
                        <span class="mt-2 font-semibold">DuitNow QR</span>
                        <p class="text-slate-500 text-sm leading-6">Delivery: 2-4 Days</p>
                    </div>
                </label>
            </div>
            <div class="relative">
                ...
                <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
                    ...
                    <div class="ml-5">
                        <span class="mt-2 font-semibold">Pay at Counter</span>
                        <p class="text-slate-500 text-sm leading-6">Delivery: 2-4 Days</p>
                    </div>
                </label>
            </div>
